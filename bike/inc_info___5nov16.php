						...
						<div class="b-info__latest">
							...
							<div class="b-info__latest-article wow zoomInUp" data-wow-delay="0.3s">
								...
								<div class="b-info__latest-article-info">
									<h6><a href="detail.html">Honda CD 70</a></h6>
							...
							<div class="b-info__latest-article wow zoomInUp" data-wow-delay="0.3s">
								...
								<div class="b-info__latest-article-info">
									<h6><a href="#">SUZUKI AV -100</a></h6>
									<p><span class="fa fa-tachometer"></span> 15,000 KM</p>
								</div>
							</div>
							<div class="b-info__latest-article wow zoomInUp" data-wow-delay="0.3s">
								<div class="b-info__latest-article-photo m-aston"></div>
								<div class="b-info__latest-article-info">
									<h6><a href="#">YAMAHA MB-100</a></h6>
									<p><span class="fa fa-tachometer"></span> 5,000 KM</p>
								</div>
							</div>
						</div>
					</div>
