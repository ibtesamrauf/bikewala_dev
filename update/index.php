...
<head>
<title>Update - Car Trading Made Easy</title>
...
$_SESSION["autoadmin_settings"]['authorization_code']=$authorization_code;
$_SESSION["autoadmin_settings"]['purchase_code']=$purchase_code;
