    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-3 position-r <?php if($rtl) print " pull-right "; ?>">
                ...
                <?php if(trim($autoadmin_settings['websitelogo'])!=""){ ?>
                <img src="uploads/<?php print $autoadmin_settings['websitelogo']; ?>" class="logo-img" alt='<?php print $reSiteName; ?>'> 
                <img src="uploads/<?php print $autoadmin_settings['websitelogo']; ?>" class="mobile-only" align="..." alt='<?php print $reSiteName; ?>'>
   ...
   ?>
    ...
    <li <?php if($ptype=="contactus") print " class='active' "; ?>><a href='<?php print $contactPageLink; ?>'><?php print $relanguage_tags["Contact us"];?></a></li>
            ...
            <div class="col-sm-2 <?php if($rtl) print " pull-left "; ?>">
                ...
                <div class="modal fade bg" id="forgotModal" tabindex="-1" role="dialog" style="z-index:10000" aria-labelledby="forgotModalLabel" aria-hidden="true">
                      ...
                      <div class="modal-body">
                        <div role="tabpanel" class="bs-example bs-example-tabs">
                            <ul role="tablist" class="nav nav-tabs sign-tab" id="myTab">
                                ...
                                <li role="presentation" class=""><a aria-controls="profile" data-toggle="tab" id="profile-tab" role="tab" href="#profile" aria-expanded="false">New account</a></li>
                            </ul>
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="input-group ui-widget">
                                <input type="text" id='searchQuery' class="form-control search-field" placeholder="<?php print __("Start typing city name to view matching results or leave it empty to view all listings"); ?>">
    ...
    <div class="rentals">
      <div class="container">
        <div class="row">
         ...
         <div class="col-xs-3 txt-align-r"><a href='index.php?ptype=' class="btn btn-primary btn-sm btn-bg-blue" type="button"><?php print __("View Listings"); ?></a></div>
        </div>
      </div>
    </div>
            ...
            <div class="col-xs-6">
             <ul data-show-less-text="Less" data-show-more-text="More" data-visible-count="5" >
                   ...
                   while($count<$eachRow){
                       ...
                       if($_SESSION["autoadmin_settings"]["refriendlyurl"]=="enabled") $cityLink="city/".$record['city'];
...
source: "infoResults.php?type=30&stype="+searchOption,
minLength: 2,
