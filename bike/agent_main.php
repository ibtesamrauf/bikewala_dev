...
<html>
	...
	<!--b-nav-->
		<section class="b-pageHeader">
			<div class="container">
				<h1 class="wow zoomInLeft" data-wow-delay="0.3s">Agent Control Panel</h1>
				<div class="b-pageHeader__search wow zoomInRight" data-wow-delay="0.3s">
					<h3>Agent Access Area</h3>
				</div>
			</div>
					...
					<div class="col-lg-9 col-md-8 col-sm-7 col-xs-6">
						<div class="b-submit__main">
							<div class="b-submit__main-contacts wow zoomInUp" data-wow-delay="0.3s">
								...
								<p>Welcome to our website. Agent can perform following tasks<br><br>
                                * Add Bike Detail<br>
