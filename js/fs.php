...
<?php if($_SESSION['rtl']){ ?>$('#mapResults').css('margin-right',mapSidebarWidth+'px'); $('#mapResults').css('margin-left','0px');
<?php }else{ ?>$('#mapResults').css('margin-left',mapSidebarWidth+'px'); $('#mapResults').css('margin-right','0px'); <?php } ?>
