...
if ($recaptchaResponse=="no") {
 print "<h3 align='center'>".$relanguage_tags["The reCAPTCHA wasn't entered correctly"].". <a href='javascript:history.go(-1);'>".$relanguage_tags["Go back and try again"]."</a>.</h3>";
}else{ //send email
