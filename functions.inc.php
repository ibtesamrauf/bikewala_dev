...
function addNewFeature($newFeature,$itemTable){
	...
	if($isThisDemo=="no" && trim($newFeature)!="-"){
		if(strpos($row0['all_features'], $newFeature)===false){
			...
			//print $qr1;
			if(strtolower($redefaultLanguage)=="english") addNewTag("$newFeature:::$newFeature:::$redefaultLanguage");
			if($result1) print "<p align='center'>The new item ".stripslashes($newFeature)." has been added.</p>";
			else print "<p align='center'>The new item ".stripslashes($newFeature)." couldn't be added. ".mysql_error()."</p>";
...
function removeFeature($featureName,$itemTable){
	...
	if($isThisDemo=="no" && trim($featureName)!=""){
		...
		for($i=0;$i<$allFeaturSize;$i++){
			$allFeaturesArray[$i]=mysql_real_escape_string($allFeaturesArray[$i]);
		...
		else print "<p align='center'>The item ".stripslashes($featureName)." couldn't be removed. ".mysql_error()."</p>";
...
if($totalcats>0){
	...
	else print "<p align='center'>Model ".stripslashes($subcat)." couldn't be added to $category. ".mysql_error().".</p>";
